	...
	<div class="main">
			...
			<div class="row2">
				<nav>
					<div class="topnav">
						...
						<a href="manageReservation.jsp">Delete Reservation</a>
		...
		<table class="signup1" border="1" cellpadding="10" >
			...
			<c:forEach items="${users}" var="item">
						...
						<td><input type="text" name="role" readonly value="<c:out value='${item.reservation_id}'/>" ></td>
						<td><input type="text" name="status" readonly value="<c:out value='${item.carType}'/>" ></td>
						</tr>
						</c:forEach>
			</table>
